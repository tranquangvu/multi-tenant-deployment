...
# Usage: [TEMPLATES_S3_BUCKET=my-bucket] [TEMPLATES_S3_PREFIX=cfn/templates] ./upload-templates.sh
# Default bucket: go-ascendasia when TEMPLATES_S3_BUCKET is unset.
set -euo pipefail

BUCKET="${TEMPLATES_S3_BUCKET:-go-ascendasia}"
